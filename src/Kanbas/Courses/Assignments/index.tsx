...
export default function Assignments() {
  ...
  <ul id="wd-modules" className="list-group rounded-0">
    <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray ">
      <div className="dropdown-toggle wd-title p-3 ps-2 bg-secondary "> <BsGripVertical className="me-2 fs-3 " />
    ...
    <b><a className="wd-assignment-link text-decoration-none text-muted" href="#/Kanbas/Courses/1234/Assignments/123">
      ...
      <div className="module-info text-muted">
        ...
        <span> <b>Not available until May 6 at 12:00am</b></span> |<br />
    ...
    <div className="col-md-2 text-end">
      <LessonControlButtons/>
        ...
        <li className="wd-lesson list-group-item p-3 ps-1"> <div className="row assignment-item py-3 align-items-center">
    <div className="col-md-1 d-flex align-items-center">
    <BsGripVertical className="me-2 fs-3" />
      <HiOutlinePencilAlt className="me-2 fs-3 " color="green"/>
    </div>
